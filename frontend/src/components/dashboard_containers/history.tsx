...
import './orders.css';
import { GetDelivered} from '../../actions/orderActions';
...
class History extends React.Component<any,any>{
    public static propTypes = {getDelivered: PropTypes.func.isRequired, user: PropTypes.object.isRequired}
    ...
    public async componentDidMount(){
        ...
        await this.props.getDelivered(user.unique_name).then(async (result) => await this.setState({orders: result}), (error) => console.log(error))
...
export default connect(mapStateToProps, {getDelivered: GetDelivered})(History);
